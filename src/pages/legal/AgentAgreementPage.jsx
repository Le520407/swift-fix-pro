...
const AgentAgreementPage = () => {
  ...
  useEffect(() => {
    const loadAgentAgreement = async () => {
      try {
        setLoading(true);
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading Agent Agreement...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Unable to load Agent Agreement</p>
        </div>
      </div>
    );
  }
...
export default AgentAgreementPage;
